...
Use this durable JSON shape when a manifest gate is marked `pass`:

```json
{
  "id": "UD-001",
  "question": "Which deployment boundary is in scope?",
  "decision": "single-process local",
  "decided_by": "user",
  "timestamp": "2026-09-03T00:00:00+08:00",
  "scope": "R-001",
  "alternatives": ["single-process local", "service boundary"],
  "record_ref": "00-scope-and-authority.md#UD-001"
}
```
